...
*The author acknowledges there are two major flaws with the entire concept - it cannot defend against radio recievers that do not follow the bluetooth low energy specification, and the high chance that in practice it's use would be illegal.*
