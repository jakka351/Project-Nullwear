...
All of this is open source under the GNU General Public License. The intent is that any law-enforcement or national-security agency in any friendly jurisdiction can take this work, build the devices via a domestic contract manufacturer (not Chinese), and protect their officers, without legal encumbrance.
...
This documentation is occasionally direct, occasionally informal. That is deliberate. The author's view is that the safety of law-enforcement officers is too serious for corporate hedging, and the engineering is too important to be obscured by jargon, and that those who seek to profiteer from the works will inevitably cut corners in that attempt - ultimately causing a loss of the key functionality of the whole system There is a very good reason that the supply chain and its integrity is a part of the mitigation of the vulnerability - the core functionality of this entire system is dependent on precise timing down to the microsecond, and if any one part of the system is not at par then the entire system will fail. This has been published in the way it has such that the intended users of it don't have to deal with the usual bullshit that comes with a capitalistic endeavour, it offers them oppurtunity to bypass that entirely and go direct to manufacturer and set their own terms without middleman or the unscrupulous profiting from the public purse in the midst of crisis, the author hates that bullshit.

This is the best I can do with the resources I have at my disposal, so if you find a passage that you cannot independently verify, or a claim that overstates what the device demonstrably does, file an issue - that is the entire point of the repository. The goal is to produce a piece of work that an officer can stake their physical safety on, knowing what it does and what it does not.
